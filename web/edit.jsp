<%-- 
    Document   : edit
    Created on : May 9, 2022, 8:50:59 PM
    Author     : Admin
--%>
    ...
    <form  action ="edit" method="post" >
            ...
            <div class="modal-body">					
                    <div class="form-group">
                            ...
                            <input type="text" value ="${pro.productID}" name="aid" class="form-control" required>
                    </div>
                    <div class="form-group">
                            <label>Product_name</label>
                            <input type="text" value ="${pro.name}" name="an" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                   <label>Brand</label>
                            <input type="text" value ="${pro.brand}" name="ab" class="form-control" required>
                    </div>
                    <div class="form-group">
                            <label>color</label>
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" value ="${pro.description}" name="ades" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" value ="${pro.quantity}" name="aq" class="form-control" required>
                    </div>
                    <div class="form-group">
